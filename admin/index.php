...
<html lang = "en">
    ...
    <body>
        <div class="container-fluid"> 
          <img src="C:/xamp/htdocs/dhtl/logo.png" alt="">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                      <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                        <a href="logout.php" class="btn btn-primary" style="margin-left: 600px;">Đăng Xuất</a>
                        </li>
            ...
            <div class="row nav-menu" style="margin-left: 2px;" > 
                  <div class="col-md">
                  <a href="them.php" class="btn btn-primary">Thêm mới</a>
                    <div class=row>
                          ...
                          <tbody>
                            ...
                            ?>      
                              <tr>
                                ...
                                <td><a href="suaNhanVien.php?manv=<?php echo $row['manv'];?>"><i class="bi bi-pencil-square"></i></a></td>
                                <td><a href="xoaNhanVien.php?manv=<?php echo $row['manv'];?>"><i class="bi bi-trash"></i></a></td>
