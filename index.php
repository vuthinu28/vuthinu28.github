...
<html lang = "en">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                      <ul class="navbar-nav">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                         ...
                         <a href="login.php" class="btn btn-primary" style="margin-left: 600px;">Đăng nhập</a>
</div>
                      </ul>
                    </div>
                  </div>                      
    ...
    <footer class="text-center text-white fixed-bottom" style="background-color: #6c757d;">
  <!-- Grid container -->
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    Danh bạ điện tử Đại học Thủy Lợi
